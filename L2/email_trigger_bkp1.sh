...
# Input report file
input_file="L2_CI_Consolidate_report1.txt"
# Output HTML file
output_file="report.html"
# Email recipient
#recipient="holger.metschulat1@telekom.de, Michael.Hoerth1@telekom.de, a4-cicd-reports1@telekom.de, Sebastian.Schwabe1@t-systems.com,alexander.gedrovics1@telekom.de,gurmeet.singh@radisys.com,vuppara@radisys.com,venkatesh.rdt@gmail.com"
...
while IFS=',' read -r component total_tests passed failed pass_percentage avg_pass_percentage test_report test_report_name detailed_report branch_name report_status; do
    ...
    elif (( $(echo "$avg_pass_percentage > 70" | bc -l) )) && (( $(echo "$avg_pass_percentage < 90" | bc -l) )); then
