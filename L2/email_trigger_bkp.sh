...
# Email recipient
recipient="holger.metschulat@telekom.de, Michael.Hoerth@telekom.de, a4-cicd-reports@telekom.de, Sebastian.Schwabe@t-systems.com,alexander.gedrovics@telekom.de,gurmeet.singh@radisys.com,vuppara@radisys.com,venkatesh.rdt@gmail.com"
