...
#my $statusFile = $ARGV[0];
$ToEmail = "orga4-scrummasters\@radisys.com, orga4-managers\@radisys.com, orgA4-Infra\@radisys.com, orga4-architects\@radisys.com,orgA4-NWMEMS\@radisys.com,orgA4-SIT\@radisys.com,orgA4-NWMPoD\@radisys.com";

$ccEmail = "orgA4-Devops\@radisys.com, holger.metschulat\@telekom.de, Michael.Hoerth\@telekom.de, a4-cicd-reports\@telekom.de, v.santinelli\@reply.de, Florian.Krumbholz\@t-systems.com, SpaceJam\@mg.telekom.de, guruprasanna.st\@radisys.com, Sebastian.Schwabe\@telekom.com ";
