...
#my $statusFile = $ARGV[0];
#$ToEmail = "orga4-scrummasters1\@radisys.com, orga4-managers1\@radisys.com, orgA4-Infra1\@radisys.com, orga4-architects1\@radisys.com,orgA4-NWMEMS1\@radisys.com,orgA4-SIT1\@radisys.com,orgA4-NWMPoD1\@radisys.com";

#$ccEmail = "dta4_devops_rmqa\@radisys.com, holger.metschulat1\@telekom.de, Michael.Hoerth1\@telekom.de, a4-cicd-reports1\@telekom.de, v.santinelli1\@reply.de, Florian.Krumbholz1\@t-systems.com, SpaceJam1\@mg.telekom.de, guruprasanna.st1\@radisys.com, Sebastian.Schwabe1\@telekom.com ";

$ToEmail = "Hemalatha.Ragamsetti\@radisys.com";
$ccEmail = "DTA4_DevOps_RMQA\@radisys.com";
#$ccEmail = "Hemalatha.Ragamsetti\@radisys.com";
