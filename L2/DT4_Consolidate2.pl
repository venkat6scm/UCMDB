...
<tr height = 100 bgcolor=#6699CC><th>COMPONENT NAME</th><th>TOTAL TEST</th><th>TEST PASSED</th><th>TEST FAILED</th><th>Test Report</th><th>Report Status</th><th>TESTS PASS PERCENTAGE</th></tr>";
...
sub createHtml
{
        ...
        {
                 $data=$data."<tr><td>$compilationName[$i]</td><td bgcolor=#33EE11>$buildStatus[$i]</td><td>$buildurl[$i]</td><td>$p1_Bul[$i]</td><td>$p2_Bul[$i]</td><td>$p3_Bul[$i]</td><td>$buildtime[$i]</td><td>$Build_duration[$i]</td><td>$commitid[$i]</td><td>$fail_Bul[$i]</td></tr>";
        }
...

{
                          ...
                          $failData=$failData."<tr><td><a href=\"$Build_duration[$i]\">$compilationName[$i]</a></td><td>$buildStatus[$i]</td><td bgcolor=#33EE11>$buildtime[$i]</td><td>$buildurl[$i]</td><td>$p1_Bul[$i]</td><td><a href=\"$p2_Bul[$i]\">$commitid[$i]</a></td><td>$p3_Bul[$i]</td><td>$fail_Bul[$i]</td></tr>";
...
$failData=$failData."<tr><td><a href=\"$Build_duration[$i]\">$compilationName[$i]</a></td><td>$buildStatus[$i]</td><td bgcolor=#33EE11>$buildtime[$i]</td><td bgcolor=#FF4411>$buildurl[$i]</td><td>$p1_Bul[$i]</td><td><a href=\"$p2_Bul[$i]\">$commitid[$i]</a></td><td>$p3_Bul[$i]</td><td>$fail_Bul[$i]</td></tr>";
...
$failData=$failData."<tr><td><a href=\"$Build_duration[$i]\">$compilationName[$i]</a></td><td>$buildStatus[$i]</td><td>$buildtime[$i]</td><td>$buildurl[$i]</td><td>$p1_Bul[$i]</td><td><a href=\"$p2_Bul[$i]\">$commitid[$i]</a></td><td>$p3_Bul[$i]</td><td>$fail_Bul[$i]</td></tr>";
