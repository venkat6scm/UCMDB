...
#my $statusFile = $ARGV[0];
$ToEmail = "orga4-scrummasters\@radisys.com, orga4-managers\@radisys.com, orga4-architects\@radisys.com,orgA4-NWMEMS\@radisys.com,Shashi.Kiran\@radisys.com,Mohan.Shivananjegowda\@radisys.com, Sharad.Singh\@radisys.com, Guruprasanna.ST\@radisys.com, Ramakrishna.Bodapati\@radisys.com, Vipin.Tiwari\@radisys.com, orgA4-NWMPoD\@radisys.com";


$ccEmail = "orgA4-Devops\@radisys.com, holger.metschulat\@telekom.de, Michael.Hoerth\@telekom.de, a4-cicd-reports\@telekom.de, v.santinelli1\@reply.de, vuppara\@radisys.com";
...
sub htmlForFail
{
	...
	for(my $i =0;$i<=$#compilationName;$i++)
	{
		if (defined $buildStatus[$i])
		{
			...
			elsif( $Build_duration[$i] >= 80 && $Build_duration[$i] < 95) 
			{
